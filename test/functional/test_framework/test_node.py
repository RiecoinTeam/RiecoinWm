...
class RPCOverloadWrapper():
    ...
    def createwallet(self, wallet_name, disable_private_keys=None, blank=None, passphrase='', avoid_reuse=None, descriptors=True, load_on_startup=None, external_signer=None):
