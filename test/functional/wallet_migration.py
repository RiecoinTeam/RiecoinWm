...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_basic(self):
        ...
        addr = basic0.getnewaddress(address_type="bech32")
        change = basic0.getrawchangeaddress(address_type="bech32")
        ...
        for _ in range(0, 10):
            default.sendtoaddress(basic1.getnewaddress(address_type="bech32"), 1)

        self.generate(self.nodes[0], 1)

        for _ in range(0, 5):
            basic1.sendtoaddress(default.getnewaddress(address_type="bech32"), 0.5)
        ...
        assert_equal(basic1_restored.getbalances()['mine']['trusted'], bal)
    ...
    def test_multisig(self):
        ...
        addr1 = multisig0.getnewaddress(address_type="bech32")
        addr2 = multisig0.getnewaddress(address_type="bech32")
        addr3 = multisig0.getnewaddress(address_type="bech32")

        ms_info = multisig0.addmultisigaddress(2, [addr1, addr2, addr3], address_type="bech32")
        ...
        ms_info = multisig1.addmultisigaddress(2, [multisig1.getnewaddress(address_type="bech32"), pub1, pub2], address_type="bech32")
        ms_info2 = multisig1.addmultisigaddress(2, [multisig1.getnewaddress(address_type="bech32"), pub1, pub2], address_type="bech32")
    ...
    def test_other_watchonly(self):
        ...
        received_addr = imports0.getnewaddress(address_type="bech32")
        imports0.setlabel(received_addr, "Receiving")
        received_txid = default.sendtoaddress(received_addr, 10)

        # Watchonly tx
        import_addr = default.getnewaddress(address_type="bech32")
        ...
        import_sent_addr = default.getnewaddress(address_type="bech32")
        ...
        assert_equal(watchonly.getbalance(), 11)
    ...
    def test_no_privkeys(self):
        ...
        addr = default.getnewaddress(address_type="bech32")
    ...
    def test_addressbook(self):
        ...
        df_wallet.sendtoaddress(wallet.getnewaddress(address_type="bech32"), 3)

        # Import watch-only script to create a watch-only wallet after migration
        watch_addr = df_wallet.getnewaddress(address_type="bech32")
        wallet.importaddress(watch_addr)
        df_wallet.sendtoaddress(watch_addr, 2)

        # Import solvable script
        multi_addr1 = wallet.getnewaddress(address_type="bech32")
        multi_addr2 = wallet.getnewaddress(address_type="bech32")
        multi_addr3 = df_wallet.getnewaddress(address_type="bech32")
        wallet.importpubkey(df_wallet.getaddressinfo(multi_addr3)["pubkey"])
        ms_addr_info = wallet.addmultisigaddress(2, [multi_addr1, multi_addr2, multi_addr3], address_type="bech32")
        ...
        # Test vectors
        addr_external = {
            "addr": df_wallet.getnewaddress(address_type="bech32"),
            "is_mine": False,
            "is_change": False,
            "label": ""
        }
        ...
        change_address = {
            "addr": wallet.getrawchangeaddress(address_type="bech32"),
            "is_mine": True,
            "is_change": True,
            "label": None
        }
        ...
        wallet.send(outputs=[{wallet.getnewaddress(address_type="bech32"): 2}], options={"change_address": change_address['addr']})
        self.generate(self.nodes[0], 1)
    ...
    def test_migrate_raw_p2sh(self):
        ...
        pubkey = df_wallet.getaddressinfo(df_wallet.getnewaddress(address_type="bech32"))["pubkey"]
        ...
        script_pkh = key_to_p2pkh_script(df_wallet.getaddressinfo(df_wallet.getnewaddress(address_type="bech32"))["pubkey"])
        script_sh_pkh = script_to_p2sh_script(script_pkh)
    ...
    def test_conflict_txs(self):
        ...
        def_wallet.sendtoaddress(wallet.getnewaddress(address_type="bech32"), 10)
        self.generate(self.nodes[0], 1)

        # parent tx
        parent_txid = wallet.sendtoaddress(wallet.getnewaddress(address_type="bech32"), 9)
        ...
        conflict_unsigned = self.nodes[0].createrawtransaction(inputs=[conflict_utxo], outputs=[{wallet.getnewaddress(address_type="bech32"): 9.9999}])
    ...
    def test_hybrid_pubkey(self):
        ...
        normal_pubkey = wallet.getaddressinfo(wallet.getnewaddress(address_type="bech32"))["pubkey"]
    ...
    def test_failed_migration_cleanup(self):
        ...
        wallet.addmultisigaddress(2, [wallet.getnewaddress(address_type="bech32"), get_generate_key().pubkey], address_type="bech32")
    ...
    def test_avoidreuse(self):
        ...
        reused_imported_addr = def_wallet.getnewaddress(address_type="bech32")
        ...
        reused_addr = wallet.getnewaddress(address_type="bech32")
    ...
    def test_preserve_tx_extra_info(self):
        ...
        def_wallet.sendtoaddress(wallet.getnewaddress(address_type="bech32"), 2)
        ...
        original_tx_id = wallet.sendtoaddress(address=wallet.getnewaddress(address_type="bech32"), amount=1, comment=extra_comment)
